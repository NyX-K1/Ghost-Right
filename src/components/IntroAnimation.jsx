...
const IntroAnimation = ({ onComplete }) => {
    return (
        <motion.div
            className="fixed inset-0 z-[100] bg-[#1b1f23] flex items-end justify-start overflow-hidden pointer-events-none"
            initial={{ opacity: 1 }}
            animate={{ opacity: 0 }}
        ...
        >
            ...
            <motion.svg
                viewBox="0 0 512 512"
                className="absolute text-[#0eb5ec] w-32 h-32"
                initial={{
                    x: '-20vw',
                    y: '20vh',
                    scale: 0.5,
                ...
                animate={{
                    x: '120vw',
                    y: '-120vh',
                    scale: 20, // Increase size significantly
                    opacity: 0
                }}
                transition={{
                    duration: 2,
